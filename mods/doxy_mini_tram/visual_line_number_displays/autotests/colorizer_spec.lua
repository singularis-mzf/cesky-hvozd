...
describe("subway_algorithm()", function()
    local sa = visual_line_number_displays.subway_algorithm;

    it("calculates correct colors", function()
        assert.same("#063b5c", sa(10));
        assert.same("#499ca5", sa(11));
        assert.same("#2dcbcb", sa(22));
        assert.same("#47d616", sa(30));
    end);

    it("tolerates unusual input", function()
        assert.same("#4efbef", sa(22.5));
        assert.same("#656d7f", sa(0));
        assert.same("#220c36", sa(-1));
        assert.same("#deaaec", sa(-2));
        assert.same("#1f63de", sa(-100));
        assert.same("#f181c0", sa(-10000));
        assert.same("#d8593e", sa(10000));
    end);
end);
