...
local konstal_105_definition = {
    ...
    is_locomotive = true;
    collisionbox = { -0.9, -2.5, -4, 0.9, 2.5, 4 };
    drops = {
		"technic:blue_energy_crystal 2",
		"minitram_crafting_recipes:minitram_pantograph",
		"signs_road:white_sign 2",
		"minitram_crafting_recipes:minitram_konstal_105_body_assembly",
		"minitram_crafting_recipes:minitram_bogie 2",
