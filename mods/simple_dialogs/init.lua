...
local function get_background_box(x, y, w, h)
	-- return "box["..x..","..y..";"..w..","..h..";#34200cFF]"
	local padding = 0.2
	return "background9["..(x - padding)..","..(y - padding)..";"..(w + 2 * padding)..","..(h + 2 * padding)..";ch_core_dialog_bg.png;false;8]"
end
...
function simple_dialogs.get_dialog_var(npcself,varname,playername,defaultval)
	if npcself and varname then
		...
		if varname=="PLAYERNAME" then
			...
			return ch_core.prihlasovaci_na_zobrazovaci(playername)
