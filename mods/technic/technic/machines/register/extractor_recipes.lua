...
if minetest.get_modpath("dye") then
	...
	local dye_recipes = {
		{"technic:coal_dust",                 "dye:black 4"},
		{"default:blueberries",               "dye:blue 4"},
		{"farming:blueberries",               "dye:blue 4"},
		{"flowers:mushroom_brown",            "dye:brown 4"},
		{"flowers:mushroom_red",              "dye:red 4"},
		{"default:grass_1",                   "dye:green 1"},
		{"default:dry_shrub",                 "dye:brown 4"},
		{"default:junglegrass",               "dye:green 4"},
		...
		{"farming:raspberries",               "dye:magenta 4"},
