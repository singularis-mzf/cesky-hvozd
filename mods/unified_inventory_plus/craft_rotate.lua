...
ui.pages["craft"] = {
    get_formspec = function(player, perplayer_formspec)
        ...
        formspec = formspec ..
            ("image_button[%f,%f;%f,%f;pattern_rotate.png;craft_rotate;]tooltip[craft_rotate;%s]"):format(
                perplayer_formspec.craft_x - perplayer_formspec.btn_spc,
                perplayer_formspec.craft_y,
                perplayer_formspec.btn_size,
                perplayer_formspec.btn_size,
                "Otočí obsah výrobní mřížky po směru hodinových ručiček."
            )
