...
for pname, value in pairs(plants) do
	...
	if minetest.registered_items["farming:"..pname] ~= nil then
		minetest.register_alias("cucina_vegana:"..pname, "farming:"..pname)
	elseif pname == "banana" then
		minetest.register_alias("cucina_vegana:banana", "ethereal:banana")
	elseif pname == "flax" then
		minetest.register_alias("cucina_vegana:flax", "farming:raw_flax")
		minetest.register_alias("cucina_vegana:flax_roasted", "farming:flax_roasted")
	elseif pname == "chili" then
		minetest.register_alias("cucina_vegana:chili", "farming:chili_pepper")
	elseif pname == "soy" then
		minetest.register_alias("cucina_vegana:soy", "farming:soy_pod")
	elseif pname == "peanut" and minetest.registered_items["sandwiches:peanuts"] ~= nil then
		minetest.register_alias("cucina_vegana:peanut", "sandwiches:peanuts")
	else
		error("[cucina_vegana] Expected item \"farming:"..pname.."\" does not exist!")
	end
	--[[
	if(value) then
		...
		if (cucina_vegana.farming_default) then
			print(modpath .. "/" .. pname .. "_default.lua")
