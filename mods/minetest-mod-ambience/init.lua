...
-- print(string.format("elapsed time: %.4f; set_name: %s; MORE_GAIN: %s\n", os.clock() - t1, set_name or "nil", MORE_GAIN or "nil"))
...
--print ("-- change stop", set_name, playing[player_name].handler)
				...
				print("sound set still playing, skip new sound")
			end
		end

		-- set random chance
		chance = random(1, 1000)
		-- print("random chance: "..chance..", ok = "..(ok and "true" or "false")..", set_name = "..(set_name or "nil")..", frequency = "..((sound_sets[set_name or ""] or {}).frequency or "nil"))
