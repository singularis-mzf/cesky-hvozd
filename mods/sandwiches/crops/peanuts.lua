...
if minetest.global_exists("farming") and  farming.mod == "redo" then
	...
	minetest.register_craftitem("sandwiches:peanuts", {
		...
		groups = {food = 1, food_peanut = 1, food_peanuts = 1, flammable = 1, ch_food = 1},
	})
...
minetest.register_abm({
   ...
   action = function(pos, node)
      ...
      if(next(soil_positions) ~= nil) then
...
minetest.register_craftitem("sandwiches:peanut_butter", {
    description = "burákové máslo",
    on_use = ch_core.item_eat(),
    groups = {food = 2, food_peanut_butter = 1, flammable = 1, ch_food = 2},
