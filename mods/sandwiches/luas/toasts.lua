...
minetest.register_craftitem("sandwiches:grilled_hot_cheesy_sandwich", {
		description = S("Grilled hot cheese sandwich"),
		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
		groups = {food = 10, food_sandwich = 1, food_toasted = 1, ch_food = 10},
...
minetest.register_craftitem("sandwiches:garlic_bread", {
		...
		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
		groups = {food = 4, food_garlic_bread = 1, ch_food = 4},
...
minetest.register_craftitem("sandwiches:tasty_garlic_sandwich", {
		description = S("Tasty garlic sandwich"),
		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
		groups = {food = 16, food_sandwich = 1, food_toasted = 1, ch_food = 16},
...
minetest.register_craftitem("sandwiches:fancy_garlic_sandwich", {
		description = S("Fancy garlic sandwich"),
		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
		groups = {food = 18, food_sandwich = 1, food_toasted = 1, ch_food = 18},
...
minetest.register_craftitem("sandwiches:croque_monsieur", {
		description = S("Croque Monsier"),
		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
		groups = {food = 13, food_sandwich = 1, food_toasted = 1, ch_food = 13},
