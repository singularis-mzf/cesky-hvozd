...
minetest.register_craftitem("sandwiches:bread_slice", {
    description = "krajíc chleba",
    on_use = ch_core.item_eat(),
    groups = {food = 1, food_bread_slice = 1, flammable = 1, ch_food = 1},
...
minetest.register_craftitem("sandwiches:bread_crumbs", {
    description = "drobky chleba",
    on_use = ch_core.item_eat(),
    groups = {food = 1, food_bread_crumbs = 1, flammable = 1, ch_food = 1},
...
-- BREAD PUDDING --
  ...
  minetest.register_craftitem("sandwiches:sweet_bread_pudding_raw", {
    description = "biskupský chlebíček (syrový)",
  ...
  minetest.register_craftitem("sandwiches:sweet_bread_pudding", {
    description = "biskupský chlebíček",
    on_use = ch_core.item_eat(),
    groups = {food = 10, food_sweet_bread = 1, flammable = 1, ch_food = 10},
...
-- JAM AND JELLY --
  ...
  minetest.register_craftitem("sandwiches:multi_jam", {
      description = "směsný džem",
      on_use = ch_core.item_eat(),
      groups = {food = 2, food_jam = 1, flammable = 1, ch_food = 2},
  ...
  local jj = {
    ["blue"] =  { {food_jam = 1, food_blueberry_jam = 1, flammable = 1, ch_food = 2}, "borůvková marmeláda"},
    ["rasp"] =  { {food_jam = 1, food_raspberry_jam = 1, flammable = 1, ch_food = 2}, "malinová marmeláda"},
    ["straw"] = { {food_jam = 1, food_strawberry_jam = 1, flammable = 1, ch_food = 2}, "jahodová marmeláda"},
    ["black"] = { {food_jam = 1, food_blackberry_jam = 1, flammable = 1, ch_food = 2}, "ostružinový džem"},
  }
...
minetest.register_craft({
	...
	type = "shapeless";
	recipe = {"group:food_tomato", "group:food_chili_pepper", "group:food_tomato",
...
if sandwiches.ingredient_support.herbs then
  ...
  minetest.register_craftitem("sandwiches:butter_carrots", {
  	description = "mrkev na másle",
  	on_use = ch_core.item_eat(),
    groups = {food = 3, food_tasty_veggie = 1, flammable = 1, ch_food = 3},
  ...
  minetest.register_craftitem("sandwiches:roasted_potatoes", {
  	description = "smažené brambory",
  	on_use = ch_core.item_eat(),
    groups = {food = 4, food_tasty_veggie = 1, flammable = 1, ch_food = 4},
  ...
  minetest.register_craftitem("sandwiches:caramelized_onion", {
  	description = "karamelizovaná cibule",
  	on_use = ch_core.item_eat(),
    groups = {food = 3, food_tasty_veggie = 1, flammable = 1, ch_food = 3},
...
--[[	 name,                  is definable,	fancy name, hunger,
  ...
  ["veggie"] =               {{"veggie", "veggie", "veggie"}, "Veggie", 8,
                              {"group:food_cucumber", "group:food_tomato", "group:food_baked_potato"},
  ...
  ["hot_veggie"] =           {{"veggie", "veggie", "veggie"}, "Hot veggie", 9,
                              {"group:food_tomato", "sandwiches:tabasco", "group:food_baked_potato"},
  ...
  if ingredients_registered(v[1]) then
    ...
    if v[6] ~= nil then
  	...
  	minetest.register_craftitem("sandwiches:".. k .."_sandwich", {
  		description = S(v[2].." sandwich"),
  		on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
  		groups = {food = v[3] ,food_sandwich = 1, flammable = 1, ch_food = v[3]},
...
minetest.register_craftitem("sandwiches:triple_mega_sandwich", {
	description = "trojitý sendvič",
	on_use = ch_core.item_eat("sandwiches:bread_crumbs"),
	groups = {food = 20, food_big_sandwich = 1, flammable = 1, ch_food = 20},
...
minetest.register_craftitem("sandwiches:sprinkles", {
		description = "cukrový posyp",
		on_use = ch_core.item_eat(),
		groups = {food = 1, food_sprinkles = 1, flammable = 1, ch_food = 1},
