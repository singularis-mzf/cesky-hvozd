...
minetest.register_craft({
	output = "aloz:stone_with_bauxite",
	type = "shapeless",
	recipe = {"aloz:bauxite_lump", "default:stone"},
})
...
minetest.register_node("aloz:aluminum_block", {
	...
	tiles = {"aloz_aluminum_block.png^[multiply:#e0edff"},
...
minetest.register_node("aloz:aluminum_beam", {
	...
	tiles = {"aloz_beam_top.png^[multiply:#e0edff", "aloz_beam_top.png^[multiply:#e0edff", "aloz_beam_side.png^[multiply:#e0edff"},
	paramtype2 = "colorwallmounted",
	palette = "unifieddyes_palette_colorwallmounted.png",
	groups = {cracky = 3, level= 3, aluminum = 1, ud_param2_colorable = 1},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_craft({
	output = "aloz:aluminum_beam 3",
	recipe = {
		{"", "aloz:aluminum_block", ""},
		{"", "aloz:aluminum_block", ""},
		{"", "aloz:aluminum_block", ""}
...
if minetest.get_modpath("doors") ~= nil then
	doors.register("door_aluminum", {
			...
			recipe = {
				...
				{"aloz:aluminum_ingot", "aloz:trapdoor_aluminum"},
			}
	})
	...
	minetest.register_craft({
		...
		recipe = {
			{"aloz:aluminum_ingot", "aloz:aluminum_ingot", "aloz:aluminum_ingot"},
			{"aloz:aluminum_ingot", "aloz:aluminum_ingot", "aloz:aluminum_ingot"},
			{"", "", ""},
		}
	})
