...
local signs_table = {
	...
	{ mat.dye_white, mat.dye_black, "signs_road:white_sign", "signs_road:white_right_sign", "signs_road:large_street_sign" },
	{ mat.dye_blue, mat.dye_white, "signs_road:blue_sign", "signs_road:blue_right_sign", "signs_road:blue_large_street_sign" },
	{ mat.dye_green, mat.dye_white, "signs_road:green_sign", "signs_road:green_right_sign", "signs_road:green_large_street_sign" },
	{ mat.dye_yellow, mat.dye_black, "signs_road:yellow_sign", "signs_road:yellow_right_sign", "signs_road:yellow_large_street_sign" },
	{ mat.dye_red, mat.dye_white, "signs_road:red_sign", "signs_road:red_right_sign", "signs_road:red_large_street_sign" },
	{ mat.dye_brown, mat.dye_white, "signs_road:brown_sign", "signs_road:brown_right_sign", "signs_road:brown_large_street_sign" },
	{ mat.dye_red, mat.dye_white, "signs_road:red_sign", "signs_road:red_right_sign", "signs_road:red_large_street_sign" },
	{ mat.dye_black, mat.dye_white, "signs_road:black_sign", "signs_road:black_right_sign", "signs_road:black_large_street_sign"},
	-- { "", mat.dye_black, "signs_road:inv_sign_black_text", "", "signs_road:invisible_large_street_sign_black_text"},
	-- { "", mat.dye_white, "signs_road:inv_sign_white_text", "", "signs_road:invisible_large_street_sign_white_text"},
}
...
for i, v in ipairs(signs_table) do
	...
	if itemstring_right ~= "" then
		minetest.register_craft({
			...
			recipe = {
				{dye_back, dye_front, mat.steel_ingot},
...
minetest.register_craft({
	...
	recipe = {
		{mat.dye_white, mat.dye_black, mat.dye_red},
		{mat.steel_ingot, mat.steel_ingot, mat.steel_ingot},
		{'', '', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'signs_road:white_sign', mat.dye_red},
		{'', ''},
	}
})
