...
local models = {
	...
	orange_sign = {
		...
		node_fields = {
			description = S("Orange road sign"),
			tiles = { "signs_road_sides.png^[multiply:#9d2d0a", "signs_road_sides.png^[multiply:#9d2d0a",
			          "signs_road_sides.png^[multiply:#9d2d0a", "signs_road_sides.png^[multiply:#9d2d0a",
			          "signs_road_sides.png^[multiply:#9d2d0a", "signs_road_white.png^[multiply:#9d2d0a" },
			use_texture_alpha = "opaque",
	...
	orange_right_sign = {
		...
		node_fields = {
			description = S("Orange direction sign"),
			tiles = { "signs_road_white_direction.png^[multiply:#9d2d0a" },
			use_texture_alpha = "opaque",
			inventory_image = "signs_road_white_dir_inventory.png^[multiply:#9d2d0a",
			signs_other_dir = "signs_road:orange_left_sign",
			on_place = signs_api.on_place_direction,
			on_rightclick = signs_api.on_right_click_direction,
			drawtype = "mesh",
			mesh = "signs_dir_right.obj",
	...
	orange_left_sign = {
		...
		node_fields = {
			...
			tiles = { "signs_road_white_direction.png^[multiply:#9d2d0a" },
			use_texture_alpha = "opaque",
			inventory_image = "signs_road_white_dir_inventory.png^[multiply:#9d2d0a^[transformFX",
			signs_other_dir = "signs_road:white_right_sign",
			on_place=signs_api.on_place_direction,
			on_rightclick = signs_api.on_right_click_direction,
			drawtype = "mesh",
