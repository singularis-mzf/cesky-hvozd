...
read_globals = {
	...
	ch_core = {fields = {
		...
		"prihlasovaci_na_zobrazovaci", "normalize_player", "pay_to",
		"register_nodes",
	...
	mesecon = {fields = {state = {fields = {"on", "off"}}, "receptor_on", "receptor_off"}},
	minetest = {
		fields = {
	...
	screwdriver = {fields = {"ROTATE_AXIS", "ROTATE_FACE"}},
	string = {fields = {"sub"}},
	stairsplus = {fields = {"register_all", "register_alias_all", "register_allfaces_trunk", "register_noface_trunk"}},
	table = {fields = {"copy", "insert_all"}},
	technic = {fields = {"refill_RE_charge", "register_power_tool", "set_RE_wear", "register_grinder_recipe"}},
	unifieddyes = {fields = {"generate_split_palette_nodes", "on_construct", "on_dig"}},
	unified_inventory = {fields = {"register_craft", "register_craft_type"}},
	vector = {fields = {"angle", "copy", "distance", "equals", "length", "new", "offset", "rotate", "round", "subtract", "zero"}},
