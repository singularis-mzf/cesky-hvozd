...
read_globals = {
	...
	screwdriver = {fields = {"disallow", "rotate_simple"}},
	stairsplus = {fields = {
		"analyze_shape",
		"get_recipeitems",
		"get_shape",
	...
	table = {fields = {"copy", "insert_all", "key_value_swap"}},
	technic = {fields = {
	...
	unified_inventory = {fields = {
		"current_page",
		"set_inventory_formspec",
		"register_button",
		"register_page",
	}},
	vector = {fields = {"add", "angle", "copy", "dir_to_rotation", "distance", "dot", "length", "multiply", "new", "normalize", "offset", "rotate", "round", "subtract", "zero"}},
	woodcutting = {fields = {
		"disable_for_player",
		"enable_for_player",
		"is_disabled_by_player",
	}},
	wrench = {fields = {
		"META_TYPE_FLOAT",
		"META_TYPE_INT",
...
files["mod_overrides/jonez.lua"].ignore = {"_info"}
files["trash_cans.lua"].ignore = {"_inv_size"}
