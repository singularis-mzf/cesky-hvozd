...
reg_mb_alias(20240823, "cherrytree:wood", "moretrees:cherrytree_planks")
reg_mb_alias(20240823, "cherrytree:trunk_noface", "moretrees:cherrytree_trunk_noface")
reg_alias("cherrytree:trunk", "moretrees:cherrytree_trunk")
reg_alias("cherrytree:trunk_allfaces", "moretrees:cherrytree_trunk_allfaces")
reg_alias("cherrytree:mese_post_light", "moretrees:cherrytree_mese_post_light")
reg_alias("cherrytree:blossom_leaves", "moretrees:cherrytree_leaves")
reg_alias("cherrytree:leaves", "moretrees:cherrytree_leaves")
reg_alias("cherrytree:sapling", "moretrees:cherrytree_sapling")
reg_alias("cherrytree:sapling_ongen", "moretrees:cherrytree_sapling_ongen")
reg_alias("cherrytree:gate_open", "moretrees:cherrytree_gate_open")
reg_alias("cherrytree:gate_closed", "moretrees:cherrytree_gate_closed")
reg_alias("cherrytree:fence", "moretrees:cherrytree_fence")
reg_alias("cherrytree:fence_rail", "moretrees:cherrytree_fence_rail")
