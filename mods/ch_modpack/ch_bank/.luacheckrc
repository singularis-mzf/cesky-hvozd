...
globals = {
	...
	tinv = {fields = {
		"open_trade_inventory", "close_trade_inventory", "get_trade_inventory_formspec_params",
		"read_trade_inventory", "add_item_to_trade_inventory",
		"room_for_item_in_trade_inventory", "open_simulation",
		"add_items_to_simulation", "close_simulation"
	}},
	utils = {fields = {
		"STATE_OPEN", "STATE_CLOSED", "STATE_CONFIRMED",
		"get_formspec", "formspec_callback", "give_items_to_player",
		"get_player_trade_state", "set_player_trade_state",
		"give_money_to_player",
		"mohou_obchodovat", "umoznuje_vzdalenost_obchodovani",
		"nabidnout_obchod", "zacit_obchod", "uzavrit_obchod",
		"set_is_offering_title", "set_is_trading_title",
	}},
}
